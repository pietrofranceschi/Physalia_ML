...
## in addition, whan used in data manipulation tasks, pipes do not save intermediate objects
...
Suppose, for example that you want to use t.test to compare all thenproerties of virginica and versicolor flowers
