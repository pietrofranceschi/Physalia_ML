...
![outliers](../material/outlier.png "Outliers/Anomalies")
...
We filter out all the outliers from the training set and add them to the test set, so you can get a better idea of how the model works for outlier detection.
The regular and one class SVM will be predicting on the same test data set.
