...
![outliers](../material/outlier.png "Outliers/Anomalies") One-class classification is a field of **Machine Learning** (ML) that focusses on the identification of "outliers/anomalies" in the data.
...
One-class classification algorithms include: - SVM - isolation forest - elliptic envelope - local outlier factor.
...
Imbalanced classification problems are tricky for a couple of reasons.
...
We see that we make zero errors in the majority class (easy), but 2 out of 5 mistakes (40%) in the outliers:
this is a lot!
