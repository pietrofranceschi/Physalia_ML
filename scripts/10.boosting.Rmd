...
- `multi:softprob`: multi-class classification through multinomial logistic likelihood
- `lambda`: L2 regularization term on weights (Ridge penalty) (0 means no L2 regularization)
- `alpha`: L1 regularization term on weights (Lasso penalty) (alpha = 1 → moderate L1 regularization)
