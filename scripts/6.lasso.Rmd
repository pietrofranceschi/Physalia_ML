...
Try: - a different training/test split (e.g. 70/30) - a different CV scheme for tuning the hyperparameter $\lambda$ - measure the predictive performance of the model.
Try also to calculate MCC on the results from Lasso-penalised logistic regression.
