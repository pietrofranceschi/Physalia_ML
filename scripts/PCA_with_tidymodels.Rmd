...
iris_PCA_prep %>% 
  ...
  geom_segment(data = loadings_wider, 
               mapping = aes(xend = 1.5*PC1, x = 0, y = 0, 
                             yend = 1.5*PC2), col = "steelblue") + 
...
I'll leave the second step to you ;-) ... but it is a nice matrix algebra exercise.
...
And now I can use a specific recipe for imputation ...
